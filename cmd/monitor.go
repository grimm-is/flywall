...
// It starts "flywall ctl" and restarts it if it crashes.
// If "flywall ctl" exits cleanly (code 0), the monitor also exits (assuming intentional stop).
func RunMonitor(args []string) {
	Printer.Println("Starting Flywall Self-Healing Monitor...")
	...
	for {
		...
		// Prepare command: "flywall ctl [args...]"
		...
		Printer.Printf("Monitor: Started flywall ctl (pid=%d)\n", cmd.Process.Pid)
