...
// If remoteURL is provided, it fetches the config from a remote Flywall instance.
...
func RunShow(configFile string, summary bool, remoteURL, apiKey string) error {
	...
	if summary {
		...
		// If I run `flywall show --summary`, I probably want just summary?
		// Or summary + rules?
