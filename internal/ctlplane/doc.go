// Package ctlplane implements the privileged control plane for Flywall.
//
// # Overview
//
...
// # Architecture
//
// The control plane exposes an RPC server over a Unix socket at /run/flywall/ctl.sock.
