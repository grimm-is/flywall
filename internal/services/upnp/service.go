...
func (s *Service) sendSSDPResponse(ctx context.Context, dest *net.UDPAddr, iface *net.Interface, ifaceName string) {
	...
	resp := fmt.Sprintf("HTTP/1.1 200 OK\r\n"+
		...
		"EXT:\r\n"+
		"LOCATION: %s\r\n"+
		"SERVER: Flywall/1.0 UPnP/1.1\r\n"+
		"ST: %s\r\n"+
		"USN: uuid:flywall-igd-1::%s\r\n"+
...
<root xmlns="urn:schemas-upnp-org:device-1-0">
  ...
  <device>
    ...
    <friendlyName>Flywall Firewall</friendlyName>
    <manufacturer>Flywall</manufacturer>
    <manufacturerURL>https://github.com/flywall/flywall</manufacturerURL>
    <modelDescription>Flywall High Performance Firewall</modelDescription>
    <modelName>Flywall Router</modelName>
    <modelNumber>1.0</modelNumber>
    <UDN>uuid:flywall-igd-1</UDN>
    <serviceList>
      <service>
...
func (s *Service) handleAddPortMapping(w http.ResponseWriter, r *http.Request, args *AddPortMapping) {
	...
	// We need to import "grimm.is/flywall/internal/config" to construct the rule.
