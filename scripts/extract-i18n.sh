...
~/go/bin/gotext -srclang=en update -out=internal/i18n/catalog.go -lang=en,de grimm.is/flywall grimm.is/flywall/internal/i18n grimm.is/flywall/cmd grimm.is/flywall/internal/api
