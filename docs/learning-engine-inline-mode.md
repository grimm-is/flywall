...
| File | Description |
|------|-------------|
| [nfqueue_linux.go](file:///Users/ben/projects/flywall/internal/ctlplane/nfqueue_linux.go) | Real nfqueue implementation with verdict callbacks |
| [nfqueue_stub.go](file:///Users/ben/projects/flywall/internal/ctlplane/nfqueue_stub.go) | Stub for non-Linux systems |
...
| File | Changes |
|------|---------|
| [security.go](file:///Users/ben/projects/flywall/internal/config/security.go) | Added `InlineMode` config option |
| [server.go](file:///Users/ben/projects/flywall/internal/ctlplane/server.go) | Added conditional nfqueue reader, `startInlineLearning()` |
| [config.go](file:///Users/ben/projects/flywall/internal/firewall/config.go) | Added `RuleLearning` field |
| [script_builder.go](file:///Users/ben/projects/flywall/internal/firewall/script_builder.go) | Generate `queue num X bypass` when inline mode enabled |
| [service.go](file:///Users/ben/projects/flywall/internal/learning/service.go) | Added `Engine()` accessor for inline mode |
...
render_diffs(file:///Users/ben/projects/flywall/internal/firewall/script_builder.go)
...
ok      grimm.is/flywall/internal/firewall
ok      grimm.is/flywall/internal/ctlplane
FAIL    grimm.is/flywall/internal/learning  (TestParseSNI - pre-existing failure)
ok      grimm.is/flywall/internal/learning/flowdb
```
