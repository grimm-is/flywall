...
ip route add 192.168.200.0/24 via 10.99.99.254 dev dummy0 onlink 2>/dev/null
ok $? "Can add route with gateway"

# 6. Add route with metric
ip route add 192.168.201.0/24 via 10.99.99.254 dev dummy0 metric 100 onlink 2>/dev/null
